...
import com.aurora.corona.viewmodel.DailyReportModel;
...
public class StatisticsFragment extends Fragment {
    ...
    public static final int[] COLORS = {
            Color.rgb(12, 173, 60), Color.rgb(173, 31, 12), Color.rgb(133, 12, 173),
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        model.getData().observe(getViewLifecycleOwner(), new Observer<List<Cases_time_series>>() {
            @Override
            public void onChanged(List<Cases_time_series> dailyItems) {
                StatisticsFragment.this.setupBarChart(dailyItems);
            }
        });
        setupPieChart();
    }

    private void setupBarChart(final List<Cases_time_series> casesTimeSeriesList) {
        ...
        set2.setColor(getResources().getColor(R.color.recvrGreen));
